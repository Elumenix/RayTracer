...
namespace Rendering
{
    struct Material
    {
        ...
        // Regular Constructor
        Material(Color c_color = Color(1, 1, 1), float c_ambient = 0.1f, float c_diffuse = 0.9f, float c_specular = 0.9f, float c_shininess = 200.0f, float c_reflectiveness = 0.0f, float c_transparency = 0.0f, float c_refractiveIndex = 1.0f);
